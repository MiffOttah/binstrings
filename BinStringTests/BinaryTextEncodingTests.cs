...
namespace BinStringTests
{
    ...
    public class BinaryTextEncodingTests
    {
        ...
        public void QuotedPrintableTest()
        {
            ...
            Assert.AreEqual("J'interdis aux marchands de vanter trop leur marchandises. Car ils se font =\nvite p=C3=A9dagogues et t'enseignent comme but ce qui n'est par essence qu'=\nun moyen, et te trompant ainsi sur la route =C3=A0 suivre les voil=C3=A0 bi=\nent=C3=B4t qui te d=C3=A9gradent, car si leur musique est vulgaire ils te f=\nabriquent pour te la vendre une =C3=A2me vulgaire.", longText.ToQuotedPrintableString(QuotedPrintableFormattingOptions.UseLf, CultureInfo.InvariantCulture));
            ...
            string withNewLinesQP = withNewlines.ToQuotedPrintableString(QuotedPrintableFormattingOptions.KeepNewlines | QuotedPrintableFormattingOptions.UseCrLf, CultureInfo.InvariantCulture);
